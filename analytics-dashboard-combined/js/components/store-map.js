...
const StoreMap = (function() {
  ...
  function init(containerId) {
    ...
    L.tileLayer('https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}{r}.png', {
      attribution: '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors &copy; <a href="https://carto.com/attributions">CARTO</a> | <em>Google Maps in production</em>',
      subdomains: 'abcd',
      maxZoom: 19
    }).addTo(map);
