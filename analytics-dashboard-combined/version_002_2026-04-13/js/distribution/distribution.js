...
(function() {
  ...
  function renderCrossoverDetail() {
    ...
    var CROSSOVER_COLORS_TABLE = ['#E07850', '#A8BF6E', '#2AADDB', '#9CA3AF', '#9B7FD4', '#9ca3af'];
  ...
  function initCrossoverChart() {
    ...
    var CROSSOVER_COLORS = ['#E07850', '#A8BF6E', '#2AADDB', '#9CA3AF', '#9B7FD4', '#9ca3af', '#4272D8'];
  ...
  function updateTrafficCombinedChart() {
    ...
    // Show/hide the share line + right y-axis
    chart.setOption({
      yAxis: [
        {}, // left axis unchanged
        {
          ...
          name: isVolume ? '' : 'Share %',
          nameTextStyle: { fontSize: 10, color: '#3B82F6' },
          min: isVolume ? undefined : 30,
          max: isVolume ? undefined : 70,
    ...
    stores.map(function(store, i) {
      ...
      return '<div class="bar-row" data-store-id="' + store.storeId + '">' +
        ...
        '<div class="bar-row__store">' +
          '<div class="bar-row__name">#' + store.storeNumber + ' ' + (store.city || '') + '</div>' +
        ...
        '<div class="bar-row__bar">' +
          '<div class="bar-row__track" style="width:' + totalPct.toFixed(1) + '%">' +
            '<div class="bar-row__fill bar-row__fill--new" style="width:' + newPct.toFixed(1) + '%"></div>' +
            '<div class="bar-row__fill bar-row__fill--returning" style="width:' + retPct.toFixed(1) + '%"></div>' +
            '<div class="bar-row__fill bar-row__fill--loyal" style="width:' + loyPct.toFixed(1) + '%"></div>' +
          '</div>' +
        '</div>' +
