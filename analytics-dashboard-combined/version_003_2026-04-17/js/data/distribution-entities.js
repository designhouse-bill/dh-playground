 ...
 * Brand → Sub-brand → Store
 *
 * Southeastern Grocers (SEG) → Winn-Dixie + Harveys → Real FL stores
 * Uses real store numbers, addresses, and approximate coordinates.
 */
...
const DistributionEntities = (function() {
  ...
  const allStores = [
    // ── Winn-Dixie: South Florida ──
    { id: 'store-319', storeNumber: 319, name: 'Homestead', city: 'Homestead, FL', address: '30346 Old Dixie Highway, Homestead, FL 33030', subBrandId: 'subbrand-wd-south', lat: 25.462, lng: -80.448 },
  ...
  const allSubBrands = [
    { id: 'subbrand-wd-south', name: 'South Florida', brandId: 'brand-winn-dixie', stores: allStores.filter(s => s.subBrandId === 'subbrand-wd-south') },
    { id: 'subbrand-wd-central', name: 'Central Florida', brandId: 'brand-winn-dixie', stores: allStores.filter(s => s.subBrandId === 'subbrand-wd-central') },
    { id: 'subbrand-wd-north', name: 'North Florida', brandId: 'brand-winn-dixie', stores: allStores.filter(s => s.subBrandId === 'subbrand-wd-north') },
    { id: 'subbrand-harveys', name: 'Florida', brandId: 'brand-harveys', stores: allStores.filter(s => s.subBrandId === 'subbrand-harveys') }
  ];

  // ========================================
  // Brand Definitions (Winn-Dixie + Harveys under SEG)
  // ========================================
  ...
  const brands = [
    {
      id: 'brand-winn-dixie',
      name: 'Winn-Dixie',
      subBrands: allSubBrands.filter(sb => sb.brandId === 'brand-winn-dixie')
    },
    {
      id: 'brand-harveys',
      name: 'Harveys',
      subBrands: allSubBrands.filter(sb => sb.brandId === 'brand-harveys')
    }
  ];
