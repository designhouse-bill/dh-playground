...
(function() {
  ...
  async function loadHeader() {
    ...
    HeaderComponent.init({
      ...
      onDateSelect: function() { if (typeof DistributionModals !== 'undefined') DistributionModals.openDatePicker(); },
      onEntitySelect: function() { if (typeof DistributionModals !== 'undefined') DistributionModals.openEntitySelector(); },
      onFilterAdd: function() { if (typeof DistributionModals !== 'undefined') DistributionModals.openFilterModal(); },
      onFilterRemove: handleFilterRemove
    });

    // Mark Distribution dashboard as active
    HeaderComponent.setActiveDashboard('distribution');

    // Update context bar for Distribution data
