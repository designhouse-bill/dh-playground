 ...
 * Page-specific logic for base_circulars.html
 *
...
(function() {
  ...
  function viewStoreCategories() {
    ...
    core.saveState();
    StateManager.navigateTo('base_categories.html', state, { storeId: state.selectedStoreId });
  }
  ...
  function viewStorePromotions() {
    ...
    core.saveState();
    StateManager.navigateTo('base_promotions.html', state, { storeId: state.selectedStoreId });
  }
  ...
  function openStoreInquiry() {
    ...
    core.saveState();
    StateManager.navigateTo('grid-inquiry.html', state, { storeId: state.selectedStoreId });
  }
  ...
  function compareStore() {
    ...
    core.saveState();
    StateManager.navigateTo('compare.html', state, { storeId: state.selectedStoreId });
  }
