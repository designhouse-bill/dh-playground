/* ==========================================================================
   Sidebar Editor — Accordion form with lock icons, toolbar, summary panel
   Used by both Circular Builder and PD Builder sidebar
   Exposes window.sidebarEditor
   ========================================================================== */
...
(function () {
  ...
  function renderField(fieldKey, promo, isRetailer) {
    ...
    html += ' ' + window.lockIcon.renderLockIcon(fieldKey, promo, isRetailer);
    html += '</label>';
